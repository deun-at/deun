        ...
        children: [
          ...
          FormBuilderField(
            ...
            validator: FormBuilderValidators.required(
                errorText:
                    AppLocalizations.of(context)!.expenseEntryAmountValidationEmpty),
          ...
          FormBuilderField(
            ...
            validator: FormBuilderValidators.required(
                errorText:
                    AppLocalizations.of(context)!.expenseEntrySharesValidationEmpty),
            builder: (FormFieldState<dynamic> field) {
                      ...
                      ...widget.groupMembers.map(
                        (groupMember) {
                          return FilterChip(
                              showCheckmark: false,
                              label: Text(
                                  groupMember.email == supabase.auth.currentUser?.email
