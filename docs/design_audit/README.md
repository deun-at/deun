...
- [ ] F32 · Settings/Profile · "Sprache" language control is an inset row with a leading translate icon + chevron_right; v3 Language is an iconless dropdown ("System" + chevron_down) 💅 — lib/pages/settings/settings_profile_form.dart (language row) — target: iconless dropdown-style control to match v3 (consistent with F09 icon-removal) — ev: compare/compare_settings.png
