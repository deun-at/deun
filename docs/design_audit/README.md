...
- [ ] F30 · Settings/Profile · "Aktualisieren" submit button is a stock M3 FilledButton (stadium/pill shape); v3 Update button is a radius-15 rounded rectangle ⚠️ — lib/pages/settings/settings_profile_form.dart:131 — target: use PrimaryButton (radius-15, vertical pad 15, colored soft shadow) per COMPONENTS.md §1, not FilledButton — ev: compare/compare_settings.png
